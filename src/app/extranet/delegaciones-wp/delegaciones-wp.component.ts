...
@Component({
  selector: 'app-delegaciones-wp',
  templateUrl: './delegaciones-wp.component.html',
  styleUrls: ['./delegaciones-wp.component.scss']
})
export class DelegacionesWpComponent implements OnInit {
  ...
  @ViewChild(SelectProvinciaWpComponent) hijoProvincia;
  @ViewChild(SelectLocalidadWpComponent) hijoLocalidad;
