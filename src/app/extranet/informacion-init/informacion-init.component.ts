...
@Component({
  selector: 'app-informacion-init',
  templateUrl: './informacion-init.component.html',
  styleUrls: ['./informacion-init.component.css']

})
export class InformacionInitComponent implements OnInit {
  hide1: boolean = true;
  hide2: boolean = true;
  ...
  ngOnInit() {
      ...
      if(screen.width < 1530){
        $(document).ready(function(){
           $('.mat-tab-list').css('transform', 'translateX(-380px)');
        });
      }
  }
