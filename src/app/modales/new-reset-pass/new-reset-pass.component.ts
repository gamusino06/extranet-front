...
@Component({
  ...
  templateUrl: './new-reset-pass.component.html',
  styleUrls: ['./new-reset-pass.component.css']
})
export class NewResetPassComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.userService.resetPassword(this.loginForm.value.email).subscribe(data => {
      ...
      if (data){
        ...
        this.utils.mostrarMensajeSwalFire('success', titulo, texto,'var(--vitaly-blue)', false);
      }
