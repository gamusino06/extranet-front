...
@Component({
  selector: 'app-descargaProteccionDatos',
  templateUrl: './descargaProteccionDatos.component.html',
  styleUrls: ['./descargaProteccionDatos.component.scss']
})

export class DescargaProteccionDatosComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DescargaProteccionDatosComponent>,
